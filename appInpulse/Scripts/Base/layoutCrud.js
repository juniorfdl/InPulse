        ...
        function Crud() {//PermissoesService
            return {
                ...
                link: function (scope, iElement, iAttrs, crudCtrl) {
                    ...
                    crudCtrl.ApenasConsulta = crudCtrl.crud.overrideApenasConsulta();
                    ...
                    crudCtrl.edit = function (item) {
                        ...
                        if (this.crud.ApenasConsulta) {
                            this.crud.execAntesEdit(item);
                        }
                        else {
                            var _crud = this.crud;
                            var _this = this;
        ...
        function List() {
            return {
                ...
                template: function (element, attrs) {
                    ...
                    return "\n                    <h2  ng-show=\"!luarCrudCtrl.ApenasConsulta\" ng-if=\"luarCrudCtrl.title\">{{luarCrudCtrl.title}}</h2>\n                    <div ng-transclude></div>\n                ";
                },
                transclude: true,
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrls) {
                    ...
                    scope['clicked'] = function (item, $event) {
                        ...
                        if (ctrl.ApenasConsulta) {
                            ctrl.execAntesEdit(item);
                        }
                        else {
