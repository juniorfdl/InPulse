...
(function (App) {
    ...
    (function (Controllers) {
        ...
        var CrudBaseCtrl = (function () {
            ...
            CrudBaseCtrl.prototype.overrideApenasConsulta = function () {
                return false;
            };
            /**
        ...
        var CrudBaseEditCtrl = (function (_super) {
            ...
            CrudBaseEditCtrl.prototype.buscar = function (termo, campo) {
                ...
                if (_this.ITENS_POR_PAGINA > 0) {
                    ITENS_POR_PAGINA = _this.ITENS_POR_PAGINA;
                }
                else {
                    ITENS_POR_PAGINA = this.luarApp.ITENS_POR_PAGINA;
                }

                this.crudSvc
                    .buscar(termo, this.paginaAtual, this._campoOrdenacao, this._direcaoAsc, ITENS_POR_PAGINA, campo)
                    .then(function (lista) {
                        _this.lista = lista;
                        _this.mainForm.$setPristine();
                        _this.mainForm.$setUntouched();
            ...
            CrudBaseEditCtrl.prototype.ordenar = function (nomeCampo) {
                ...
                var CamposNotOrderBy = null;

                if (this.CamposNotOrderBy != null) {
                    CamposNotOrderBy = this.CamposNotOrderBy.filter(function (d) {
                        return d.NOME == nomeCampo
                    });
                }

                if (CamposNotOrderBy == null || CamposNotOrderBy.length == 0) {
